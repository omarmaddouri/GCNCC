...
np.savetxt("{}/data/parsed_input/{}/p_val_{}/training_data.txt".format(project_path, FLAGS.dataset, FLAGS.p_value_threshold), training_data, fmt="%s")
np.savetxt("{}/data/parsed_input/{}/p_val_{}/validation_data.txt".format(project_path, FLAGS.dataset, FLAGS.p_value_threshold), validation_data, fmt="%s")
np.savetxt("{}/data/parsed_input/{}/p_val_{}/testing_data.txt".format(project_path, FLAGS.dataset, FLAGS.p_value_threshold), testing_data, fmt="%s")
np.savetxt("{}/data/parsed_input/{}/p_val_{}/extended_testing_data.txt".format(project_path, FLAGS.dataset, FLAGS.p_value_threshold), np.vstack((training_data,testing_data)), fmt="%s")
np.savetxt("{}/data/parsed_input/{}/p_val_{}/full_data.txt".format(project_path, FLAGS.dataset, FLAGS.p_value_threshold), full_data, fmt="%s")
np.savetxt("{}/data/parsed_input/{}/p_val_{}/missing_ge_idx.txt".format(project_path, FLAGS.dataset, FLAGS.p_value_threshold), missing_ge_idx, fmt="%d")

print("Successful split of the dataset under data/parsed_input/{}/p_val_{}".format(FLAGS.dataset, FLAGS.p_value_threshold))