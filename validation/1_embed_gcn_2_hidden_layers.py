...
if not os.path.isdir("{}/data/output/{}/embedding/{}/2L_dim_hidden_{}_p_val_{}".format(project_path, FLAGS.dataset, FLAGS.embedding_method, FLAGS.embedding_size, FLAGS.p_value_threshold)):
    os.makedirs("{}/data/output/{}/embedding/{}/2L_dim_hidden_{}_p_val_{}".format(project_path, FLAGS.dataset, FLAGS.embedding_method, FLAGS.embedding_size, FLAGS.p_value_threshold))
...
for epoch in range(nb_epochs):
    ...
    model_intercept = Model(inputs=model.input, outputs=model.layers[1].output)
...
#save metrics
loss_acc_log = open("{}/data/output/{}/embedding/{}/2L_dim_hidden_{}_p_val_{}/loss_acc_log.txt".format(project_path, FLAGS.dataset, FLAGS.embedding_method, FLAGS.embedding_size, FLAGS.p_value_threshold), "w")
metrics = "GCN embedding - 2 hidden layers - dim(embedding) = {} \n train_loss= {:.4f} \n train_acc= {:.4f} \n val_loss= {:.4f} \n val_acc= {:.4f} \n test_loss= {:.4f} \n test_acc= {:.4f}"\
...
np.savetxt("{}/data/output/{}/embedding/{}/2L_dim_hidden_{}_p_val_{}/embeddings.txt".format(project_path, FLAGS.dataset, FLAGS.embedding_method, FLAGS.embedding_size, FLAGS.p_value_threshold), best_embeddings, delimiter="\t")
print("Embeddings saved in /data/output/{}/embedding/{}/2L_dim_hidden_{}_p_val_{}/embeddings.txt".format(FLAGS.dataset, FLAGS.embedding_method, FLAGS.embedding_size, FLAGS.p_value_threshold))
