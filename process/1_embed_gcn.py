...
flags.DEFINE_float('p_value_threshold', 0.1, 'P-value for t-test.')
...
#save metrics
loss_acc_log = open("{}/data/output/{}/embedding/{}/loss_acc_log.txt".format(project_path, FLAGS.dataset, FLAGS.embedding_method), "w")
...
np.savetxt("{}/data/output/{}/embedding/{}/embeddings.txt".format(project_path, FLAGS.dataset, FLAGS.embedding_method), best_embeddings, delimiter="\t")
