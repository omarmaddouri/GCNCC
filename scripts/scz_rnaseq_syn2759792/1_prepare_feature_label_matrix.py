...
flags.DEFINE_string('gene_expression', 'datExpr_syn2759792.csv', 'Gene expression file.')
flags.DEFINE_string('clinical_info', 'datMeta_syn2759792.csv', 'Clinical status file.')
...
clinical_info = pd.read_csv("{}/data/raw_input/{}/{}".format(project_path, FLAGS.dataset, FLAGS.clinical_info), usecols=(0,32)).to_numpy(dtype=np.dtype(str))
column_names = []
clinical_status = []
