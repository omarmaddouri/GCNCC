...
python -u validation/6_select.py --dataset brc_microarray_netherlands --classifier svm_rbf --training_activity activity.training.txt --validation_activity activity.validation.txt --testing_activity activity.testing.txt\
...
#------------------------------------------------------------------------------------------------------------------------------------------------
##brc_microarray_usa
python -u validation/6_select.py --dataset brc_microarray_usa --classifier svm_rbf --training_activity activity.training.txt --validation_activity activity.validation.txt --testing_activity activity.testing.txt\
        --clustering_method geometric_ap --clusters clusters.txt --clusters_symbols clusters.symbols.txt --clusters_scores clusters.scores.txt\
        --labels "free","metastasis" --distance_threshold 1 --nb_features 5 --hidden_layers 3 --embedding_size 64 --p_val 0.01
python -u validation/6_select.py --dataset brc_microarray_usa --classifier svm_rbf --training_activity activity.training.txt --validation_activity activity.validation.txt --testing_activity activity.testing.txt\
        --clustering_method geometric_ap --clusters clusters.txt --clusters_symbols clusters.symbols.txt --clusters_scores clusters.scores.txt\
...
python -u validation/6_select.py --dataset scz_microarray_combined --classifier svm_rbf --training_activity activity.training.txt --validation_activity activity.validation.txt --testing_activity activity.testing.txt\
        --clustering_method geometric_ap --clusters clusters.txt --clusters_symbols clusters.symbols.txt --clusters_scores clusters.scores.txt\
...
python -u validation/6_select.py --dataset scz_rnaseq_syn2759792 --classifier svm_rbf --training_activity activity.training.txt --validation_activity activity.validation.txt --testing_activity activity.testing.txt\
        --clustering_method geometric_ap --clusters clusters.txt --clusters_symbols clusters.symbols.txt --clusters_scores clusters.scores.txt\
        --labels "control","schizophrenia" --distance_threshold 1 --nb_features 5 --hidden_layers 3 --embedding_size 64 --p_val 0.01
python -u validation/6_select.py --dataset scz_rnaseq_syn2759792 --classifier svm_rbf --training_activity activity.training.txt --validation_activity activity.validation.txt --testing_activity activity.testing.txt\
        --clustering_method geometric_ap --clusters clusters.txt --clusters_symbols clusters.symbols.txt --clusters_scores clusters.scores.txt\
...
python -u validation/6_select.py --dataset scz_rnaseq_syn4590909 --classifier svm_rbf --training_activity activity.training.txt --validation_activity activity.validation.txt --testing_activity activity.testing.txt\
        --clustering_method geometric_ap --clusters clusters.txt --clusters_symbols clusters.symbols.txt --clusters_scores clusters.scores.txt\
        --labels "control","schizophrenia" --distance_threshold 1 --nb_features 5 --hidden_layers 3 --embedding_size 64 --p_val 0.01
python -u validation/6_select.py --dataset scz_rnaseq_syn4590909 --classifier svm_rbf --training_activity activity.training.txt --validation_activity activity.validation.txt --testing_activity activity.testing.txt\
        --clustering_method geometric_ap --clusters clusters.txt --clusters_symbols clusters.symbols.txt --clusters_scores clusters.scores.txt\
